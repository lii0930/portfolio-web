    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center">
          ...
          >
            Ad consectetur laborum consectetur ut in eiusmod. Veniam voluptate
            consectetur excepteur adipisicing sunt anim adipisicing in voluptate
            mollit cillum proident ex. Cupidatat ea sunt tempor incididunt qui
            aute aliqua aute cupidatat.{" "}
          </motion.p>
          {/* counters */}
          <motion.div
